...
const proxy = {
  "/cts/*": {
    ...
    // "target": "http://192.168.140.154:28002", //andy
    //   "target": "http://192.168.140.150:28002", //hope
    "changeOrigin": true
  }
};
...
module.exports = (target = "web",
  ...
  const publicUrl = IS_PROD ? paths.servedPath.slice(0, -1) : "";
  const dotenv = getClientEnv(target, {clearConsole, host, port, publicUrl});
  ...
  if (IS_WEB) {
    ...
    if (IS_DEV) {
      ...
      // let appData = require('../templatedata/template.json'); //�½���ѡ��ģ������
      // let appData2 = require('../templatedata/candidate2.json'); //��ѡ������ģ������
      // let appData3 = require('../templatedata/candidatelist.json'); //��ѡ������ģ������
      ...
      config.devServer = {
        ...
        before(app) {
          ...
          //     })
          // });
          // app.get('/api/getNewsList2', (req, res) => {
          //     res.json({
          //         data: appData2
          //     })
          // });
          // app.get('/api/getCandidateList', (req, res) => {
          //     res.json({
          //         data: appData3
          //     })
          // });
